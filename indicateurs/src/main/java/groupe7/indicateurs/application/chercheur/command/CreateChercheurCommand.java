...
public class CreateChercheurCommand extends ChercheurCommand {
    private String nom;
    ...
    public CreateChercheurCommand(String nom, String prenom, Boolean hdr, String statut, String equipe, Boolean titulaire, LocalDate date_debut, LocalDate date_fin, List<Projet> projets,List<ArticleDTO> articles) {
