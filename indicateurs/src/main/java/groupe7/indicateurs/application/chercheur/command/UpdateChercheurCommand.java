...
public class UpdateChercheurCommand extends ChercheurCommand {
    private Long id;
    private String nom;
    ...
    public UpdateChercheurCommand(Long id, String nom, String prenom, Boolean hdr, String statut, String equipe, Boolean titulaire, LocalDate date_debut, LocalDate date_fin, List<Projet> projets,List<ArticleDTO> articles) {
