...
public class CreateAutrePosteCommand extends AutrePosteCommand {
    private String nom;
    ...
    public CreateAutrePosteCommand(String nom, String prenom, Boolean hdr, String statut, String equipe, Boolean titulaire, LocalDate date_debut, LocalDate date_fin, List<Projet> projets, String titre,List<ArticleDTO> articles) {
